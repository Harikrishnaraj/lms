-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('COURSE_ASSIGNED', 'ASSESSMENT_RESULT', 'COURSE_COMPLETED', 'CERTIFICATE_ISSUED', 'ANNOUNCEMENT');

-- AlterTable
ALTER TABLE "courses" ADD COLUMN     "certificate_validity_days" INTEGER;
